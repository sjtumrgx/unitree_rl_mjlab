...
def _default_stage_scenarios() -> dict[str, list[BenchmarkScenario]]:
  ...
  return {
    ...
    "stage3": [
      BenchmarkScenario(
        name="walking-pushkick-l1",
        bucket="walking_push_kick",
        description="Stage 3 walking-biased flat push/kick bucket L1.",
        level=1,
        difficulty="L1",
        episodes=3,
        seed=700,
        ...
        disturbance_onset_s=1.0,
        env_overrides=mild_walk,
        tags=["flat", "walking", "pushkick", "recovery"],
      ),
      BenchmarkScenario(
        name="walking-pushkick-l2",
        bucket="walking_push_kick",
        description="Stage 3 walking-biased flat push/kick bucket L2.",
        level=2,
        difficulty="L2",
        episodes=3,
        seed=800,
    ...
    "stage4a": [
      BenchmarkScenario(
        name="lateral-kick-l1",
        bucket="lateral_push_kick",
        description="Stage 4a lateral / asymmetric kick bucket L1.",
        level=1,
        difficulty="L1",
        episodes=3,
        seed=900,
        ...
        disturbance_onset_s=1.0,
        env_overrides=mild_walk,
        tags=["flat", "lateral", "pushkick", "recovery"],
      ),
      BenchmarkScenario(
        name="lateral-kick-l2",
        bucket="lateral_push_kick",
        description="Stage 4a lateral / asymmetric kick bucket L2.",
        level=2,
        difficulty="L2",
        episodes=3,
        seed=1000,
    ...
    "stage4b": [
      BenchmarkScenario(
        name="mixed-pushkick-l1",
        bucket="mixed_push_kick",
        description="Stage 4b hardest mixed push/kick bucket L1.",
        level=1,
        difficulty="L1",
        episodes=3,
        seed=1100,
        ...
        disturbance_onset_s=1.0,
        env_overrides=mild_walk,
        tags=["flat", "mixed", "pushkick", "recovery"],
      ),
      BenchmarkScenario(
        name="mixed-pushkick-l2",
        bucket="mixed_push_kick",
        description="Stage 4b hardest mixed push/kick bucket L2.",
        level=2,
        difficulty="L2",
        episodes=3,
        seed=1200,
