...
from .env_cfgs import (
  ...
  PARKOUR_TASK_ID,
  unitree_g1_parkour_complex_terrain_debug_env_cfg,
...
register_mjlab_task(
  task_id=PARKOUR_COMPLEX_TERRAIN_DEBUG_TASK_ID,
  env_cfg=unitree_g1_parkour_complex_terrain_debug_env_cfg(),
  play_env_cfg=unitree_g1_parkour_complex_terrain_debug_env_cfg(play=True),
  rl_cfg=unitree_g1_parkour_runner_cfg(),
  runner_cls=VelocityOnPolicyRunner,
)
