...
def make_velocity_env_cfg() -> ManagerBasedRlEnvCfg:
  ...
  terminations = {
    ...
    # Reset corrupted worlds before observation computation so sporadic NaN/Inf
    # physics states do not leak into actor/critic observations and kill one DDP
    # rank while the others stall in NCCL collectives.
